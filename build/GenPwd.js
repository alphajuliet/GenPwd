  ...
  var generator2 = {
    ...
    randomWord: function () {
      ...
      switch (c) {
        ...
        case 1: w = syll() + R.punc() + syll() + R.cap(syll()); break;
        case 2: w = R.v1() + R.cap(syll()) + R.punc() + syll() ; break;
        case 3: w = syll() + R.v1() + R.cap(syll()) + R.punc(); break;
        default: w = syll() + R.cap(syll()) + R.punc();
      }
